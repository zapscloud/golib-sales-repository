...
type CatalogueDao interface {
	...
	Delete(catalogueId string) (int64, error)
}

// NewCategoryDao - Contruct Business Category Dao
func NewCatalogueDao(client utils.Map, business_id string) CatalogueDao {
	var daoCatalogue CatalogueDao = nil
	...
	case db_common.DATABASE_TYPE_MONGODB:
		daoCatalogue = &mongodb_repository.CatalogueMongoDBDao{}
	...
	if daoCatalogue != nil {
		// Initialize the Dao
		daoCatalogue.InitializeDao(client, business_id)
	}
