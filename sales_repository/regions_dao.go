...
type RegionDao interface {
	...
	Delete(regionId string) (int64, error)
}

// NewRegionDao - Contruct Business Region Dao
func NewRegionDao(client utils.Map, business_id string) RegionDao {
	...
	if daoRegion != nil {
		// Initialize the Dao
		daoRegion.InitializeDao(client, business_id)
	}
